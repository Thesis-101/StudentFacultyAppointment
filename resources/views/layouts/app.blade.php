                ...
                @guest
                            ...
                            <li class="nav-item">
                                ...
                                @if (Auth::user()->user_type == 'student')
                                    <a href="{{ url('/') }}" class="nav-link">
                                        <svg class="bi me-2 text-white" width="16" height="16"><use xlink:href="#home"/></svg>
                                        Home
                                    </a>
                                @endif
                            </li>
                        ...
                        @else
                            ...
                            @elseif (Auth::user()->user_type == 'student')
                                <li class="nav-item">
                                    <a href="{{ url('student/faculty-list') }}" class="nav-link">Faculty List</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('student/request-list') }}" class="nav-link">My Requests</a>
                                </li>
                                <li class="nav-item">
